...
- **Caps** are flat comma tokens: `text,offer,cta,savings,disclosure,compliance,save,barcode.code128,barcode.ean13,barcode.upca,barcode.qr`. See `CAPS_1_7_0` in `lib/cards/types.ts` for what each 1.7.0 surface sends.
