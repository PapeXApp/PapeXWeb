...
//
// Both flags this gate protects (NEXT_PUBLIC_MERCHANT_DEMO_HOST_ANY in
// lib/merchantHost.ts, NEXT_PUBLIC_MERCHANT_MOCK in lib/merchantApi.ts) pass
// through demoOverridesAllowed(). If these cases fail, either papex.app is
// one merge away from serving the merchant dashboard, or a real merchant is
// one merge away from being shown invented transactions. Treat a failure
// here as that, not as a flaky test.
