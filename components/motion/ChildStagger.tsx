...
/**
 * Staggers its direct children in from `translateY(14px)` / `blur(8px)` /
 * `opacity:0`, 700ms with an 80ms per-child stagger, triggered once the
 * container enters view. Used on hero copy columns / step lists.
 *
